...
$releaseExe = Join-Path $scriptDir '..\release\LAN Games Deployer v1.2\LANGamesDeployer.exe'
...
Write-Host "Installer built: $outDir\LAN_Games_Deployer_Setup_v1.2_xp32.exe"
